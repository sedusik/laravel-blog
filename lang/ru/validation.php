...
return [
    ...
    */
    ...
    'hex_color' => 'Поле :attribute должно быть допустимого шестнадцатеричного цвета.',
    ...
    'present_unless' => 'Поле :attribute должно присутствовать, если только :other не является :values.',
    'present_with' => 'Поле :attribute должно присутствовать при наличии параметра :values.',
    ...
    'required_if_accepted' => 'Поле :attribute является обязательным, когда принимается значение :other.',
    'required_if_declined' => 'Поле :attribute обязательно для заполнения, если параметр :other отклонен.',
